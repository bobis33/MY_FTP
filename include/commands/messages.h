...
static const char SYNTAX_ERROR_500[] = "500 Syntax error, command unrecognized.\r\n";
static const char SYNTAX_ERROR_501[] = "501 Syntax error in parameters or arguments\r\n";
